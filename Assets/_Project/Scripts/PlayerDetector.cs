...
namespace Platformer {
    public class PlayerDetector : MonoBehaviour {
        ...
        [SerializeField] float detectionRadius = 8f; // Large circle around enemy
        [SerializeField] float innerDetectionRadius = 1f; // Small circle around enemy
        [SerializeField] float detectionCooldown = 0.1f; // Time between detections
